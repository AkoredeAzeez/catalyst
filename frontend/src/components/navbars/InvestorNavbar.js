...
export function InvestorNavbar() {
  ...
  useEffect(() => {
    const fetchNavbarData = async () => {
      try {
        ...
        const [profileResponse, notificationsResponse] =
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-neutral-100 bg-white backdrop-blur-sm py-2">
      <div className="flex h-11 items-center justify-between mx-auto max-w-7xl px-4">
        {/* Logo */}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <svg
              className="w-3 h-3 text-neutral-400 hidden sm:block"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
