  ...
  return (
    <Card className="rounded-[15px] bg-white border border-neutral-300 w-[271px] h-full">
      <CardContent className="p-3.5 flex flex-col gap-1">
        {/* Profile Section */}
        <Card className="rounded-lg border border-neutral-200 bg-white">
        ...
        <div className="mt-0.5 mb-0.5">
          <Card className="rounded-lg border border-neutral-200 bg-white">
            <CardContent className="p-2">
              ...
              {/* Interactive area chart matching screenshot */}
              <div className="h-20">
        ...
        <div className="grid grid-cols-2 gap-1.5 mt-0.5">
          {statItems.map((stat, index) => (
            <Card key={index} className="rounded-lg border border-neutral-200 bg-white">
              <CardContent className="p-1.5">
                <p className="text-[9px] text-neutral-500 font-medium mb-0.5">{stat.label}</p>
        ...
        <Card className="rounded-lg border border-neutral-200 bg-white">
          <CardContent className="p-1.5">
            <p className="text-[9px] text-neutral-500 font-medium mb-0.5 text-center">total Properties</p>
        ...
        <div className="grid grid-cols-2 gap-1.5">
          <Card className="rounded-lg border border-neutral-200 bg-white">
            <CardContent className="p-1.5">
              <p className="text-[9px] text-neutral-500 font-medium mb-0.5">Occupied</p>
              <p className="text-sm font-bold text-neutral-900">{stats.occupied.toLocaleString()}</p>
            </CardContent>
          </Card>
          <Card className="rounded-lg border border-neutral-200 bg-white">
            <CardContent className="p-1.5">
              <p className="text-[9px] text-neutral-500 font-medium mb-0.5">Vacant</p>
        ...
        <button 
          ...
          className="w-full bg-neutral-900 text-white rounded-lg py-1.5 text-[11px] font-semibold hover:bg-neutral-800 transition-colors flex items-center justify-center gap-2 mt-0.5"
        >
