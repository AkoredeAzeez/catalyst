...
>>>>>>> e1ea22e774872d3e1443df8bec1bdd5337e8c8e7

  return (
    <Card className="rounded-[15px] bg-white border border-neutral-300 w-auto h-fit">
      <CardContent
        className="p-3.5 flex flex-col gap-[13px] items-center overflow-y-auto scrollbar-hide"
        style={{
      ...
      >
        ...
        <div className="flex gap-[24px] w-[243px] h-[70.3px]">
          {statItems.map((stat, index) => (
            <Card
              key={index}
              className="rounded-[10px] border border-neutral-200 bg-white w-[111px] h-[70.3px]"
            >
