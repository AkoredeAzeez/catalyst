...
export function InvestorSidebar() {
  ...
  return (
    <div className="space-y-6 w-full max-w-[280px]">
      {/* Project Title */}
      <div>
        <h1 className="text-sm font-medium text-neutral-900">Project Lacasa Virtual Tour</h1>
      </div>
      ...
      <div className="w-full">
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="text-[10px] text-neutral-500 mb-2 font-normal">Total Earnings</div>
            <div className="text-xl font-semibold text-neutral-900 tabular-nums">${totalEarnings.toLocaleString()}</div>
          </div>
          <div className="text-right">
            <div className="text-[10px] text-neutral-500 mb-2 font-normal">Total increase</div>
            <div className="text-xl font-semibold text-neutral-900 tabular-nums">{earningsChangePercent}%</div>
          </div>
        </div>
      </div>

      {/* Completed Deals - light emerald background */}
      <div className="w-full bg-emerald-50 rounded-lg p-4 border border-emerald-100">
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="text-[10px] text-emerald-700 font-medium">Completed Deals</div>
        </div>
        <div className="flex items-end justify-between mb-3">
          <div className="text-lg font-semibold text-neutral-900 tabular-nums">{completedDeals.toLocaleString()}</div>
          <div className="text-xs font-normal text-neutral-500 tabular-nums">20%</div>
        </div>
      ...
      <div className="w-full bg-yellow-50 rounded-lg p-4 border border-yellow-100">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-4 h-4 rounded bg-white flex items-center justify-center flex-shrink-0">
          ...
          <div className="text-[10px] text-yellow-700 font-medium">Total Revenue</div>
        </div>
        <div className="flex items-end justify-between mb-3">
          <div className="text-lg font-semibold text-neutral-900 tabular-nums">{completedDeals.toLocaleString()}</div>
          <div className="text-xs font-normal text-neutral-500 tabular-nums">20%</div>
