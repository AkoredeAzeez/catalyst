          ...
          <div className="flex flex-col flex-1 justify-between">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div 
                ...
                style={{
                  width: property.status === 'Vacant' ? '56.84px' : property.status === 'Occupied' ? '77px' : 'auto',
                  height: property.status === 'Vacant' ? '21.98px' : property.status === 'Occupied' ? '23.26px' : 'auto',
                  borderRadius: property.status === 'Vacant' ? '11.37px' : property.status === 'Occupied' ? '12.03px' : '8px',
                  backgroundColor: property.status === 'Vacant' ? '#FFF8E1' : property.status === 'Occupied' ? '#E8F5E9' : '#f5f5f5',
                  color: property.status === 'Vacant' ? '#F59E0B' : property.status === 'Occupied' ? '#10B981' : '#737373',
                  fontSize: '9px',
                  padding: property.status === 'Vacant' ? '0 7.58px' : property.status === 'Occupied' ? '0 8.02px' : '0 7.58px',
                }}
              >
                {property.status}
              </div>
            ...
            <div className="flex gap-[8px]">
              <button 
                ...
                className="flex-1 bg-white text-neutral-900 rounded-[10px] text-[9px] font-semibold hover:bg-neutral-50 transition-colors"
                style={{
                  width: '220px',
                  height: '32px',
                  borderWidth: '1.5px',
              ...
              <button 
                ...
                className="bg-white rounded-[10px] hover:bg-neutral-50 transition-colors flex items-center justify-center gap-0.5"
                style={{
                  width: '70px',
                  height: '32px',
                  borderWidth: '1.5px',
              ...
              >
                ...
                <span className="text-[9px] font-semibold text-neutral-900">Edit</span>
              </button>
            </div>
          </div>
      </div>
  ...
  return (
    <div className="flex gap-4 justify-center max-w-full items-stretch">
      ...
      <div className="flex-shrink min-w-0">
        ...
        <div 
          className="border border-neutral-200 rounded-2xl p-4 h-[884px] overflow-y-scroll scrollbar-hide"
          style={{
